...
/**
 * This rule records the result of calling the getprops command on a device. It has limited use for short tests except
 * when these properties are changing between tests. Alternatively, it can be used manually in a
  ...
  public void after() {
    ...
    try {
      ...
      if (mLogFileAbsoluteLocation == null) {
        mLogFileAbsoluteLocation = getTestFile(mTestClass, mTestName, "getprops.log");
      }
      ...
      if (process.exitValue() != 0) {
        throw new Exception("Error while taking getprops, exitCode=" + process.exitValue());
      }
    }
