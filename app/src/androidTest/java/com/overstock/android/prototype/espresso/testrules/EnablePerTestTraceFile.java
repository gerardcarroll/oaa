 ...
 * <p/>
 * This JUnit rule requires the test be running on a device that has been rooted. If you don't have a device with root
 * you should prefer the systrace be pulled at the system level.
 * <p/>
