...
/**
 * This rule executes a dumpsys graphics data dump after performing the test. If the API level is less than 23 then this
 * rule will do nothing since this dumpsys command isn't supported.
 * <p/>
 * 
 * <pre>
 * &#64;Rule
    ...
    if (android.os.Build.VERSION.SDK_INT >= 23) {
      ...
      try {
        ...
        processBuilder.command("dumpsys", "gfxinfo",
          // NOTE: Using the android app BuildConfig specifically.
          BuildConfig.APPLICATION_ID, "framestats");
        processBuilder.redirectErrorStream();
        Process process = processBuilder.start();
        fileWriter = new FileWriter(getTestFile(mTestClass, mTestName, "gfxinfo.dumpsys" + ".log"));
