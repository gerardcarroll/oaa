...
/**
 * This rule resets network stats before a test and executes a dumpsys for netstats after performing the test.
 *
 * <pre>
 * &#64;Rule
    ...
    if (android.os.Build.VERSION.SDK_INT >= 21) {
      ...
      try {
        ...
        if (mLogFileAbsoluteLocation == null) {
          mLogFileAbsoluteLocation = getTestFile(mTestClass, mTestName, "netstats.dumpsys.log");
        }
