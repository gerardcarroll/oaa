...
public class OAppPrototypeApplicationTest {
    ...
    public void productServiceMockTest(){
        when(productService.getBestSellers(any(String.class))).thenReturn(Observable.just(new ProductsResponse(new Products(new ArrayList<Product>() {{
            add(new Product(1,"http://nfl.product.image.ostk.com", "nfl.product_image.png","251790/T924666.jpg" ,"TestProduct1",123.99F));
            add(new Product(2, "http://nhl.product.image.ostk.com", "nhl.product_image.png","251790/T924677.jpg" ,"TestProduct2",25.01F));
        }}))));
