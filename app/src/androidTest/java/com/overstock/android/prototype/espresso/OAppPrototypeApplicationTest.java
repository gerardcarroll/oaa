...
public class OAppPrototypeApplicationTest {
  ...
  // Dagger Mocking Rule
  @Rule
  public OAppPrototypeApplicationMockRule oAppPrototypeApplicationTest2Rule = new OAppPrototypeApplicationMockRule();

  @Rule
  public ActivityTestRule<HomeActivity> homeActivityRule = new ActivityTestRule<>(HomeActivity.class, false, false);
  ...
  private OAppPrototypeApplication getApp() {
    return (OAppPrototypeApplication) InstrumentationRegistry.getInstrumentation().getTargetContext()
  ...
  public void productServiceMockTest() {
    when(productService.getBestSellers(any(String.class)))
        .thenReturn(Observable.just(new ProductsResponse(new Products(new ArrayList<Product>() {
          {
            add(
              new Product(1, "http://nfl.product.image.ostk.com", "nfl.product_image.png", "", "T924666.jpg", 123.99F));
            add(
              new Product(2, "http://nhl.product.image.ostk.com", "nhl.product_image.png", "", "T924666.jpg", 25.01F));
          }
        }))));
