...
public class ProductServiceTest {
  ...
  public void setUp() {
    ...
    when(mockProductService.getBestSellers(any(String.class)))
        .thenReturn(Observable.just(new ProductsResponse(new Products(new ArrayList<Product>() {
          {
            add(new Product(1, "http://nfl.product.image.ostk.com", "nfl.product_image.png2", "nfl.product_image.png2",
                    123.99F));
            add(new Product(2, "http://nhl.product.image.ostk.com", "nhl.product_image.png", "nfl.product_image.png2",
                    25.01F));
          }
        }))));
    when(mockProductService.getNewArrivals(any(String.class)))
        .thenReturn(Observable.just(new ProductsResponse(new Products(new ArrayList<Product>() {
          {
            add(new Product(3, "http://nfl.product.image.ostk.com", "new.nfl.product_image.png",
                    "nfl.product_image.png2", 13.99F));
            add(new Product(4, "http://nhl.product.image.ostk.com", "new.nhl.product_image.png",
                    "nfl.product_image.png2", 15.01F));
          }
        }))));
    when(mockProductService.query(any(String.class), any(String.class), any(Integer.class)))
        .thenReturn(Observable.just(new ProductsResponse(new Products(new ArrayList<Product>() {
          {
            add(new Product(5, "http://nfl.product.image.ostk.com", "nfl.product_image.png", "nfl.product_image.png2",
                    3.99F));
            add(new Product(6, "http://nhl.product.image.ostk.com", "nhl.product_image.png", "nfl.product_image.png2",
                    2.01F));
          }
        }))));
  }
  ...
  public void testBestSellers() {
    ...
    mockProductService.getBestSellers("dummy").subscribe(new Observer<ProductsResponse>() {
      @Override
  ...
  public void testNewArrivals() {
    mockProductService.getNewArrivals("dummy").subscribe(new Observer<ProductsResponse>() {
      @Override
      public void onCompleted() {
        Log.i(TAG, "Complete");
      }
  ...
  public void testQuery() {
    mockProductService.query("dummy", "dummy2", 10).subscribe(new Observer<ProductsResponse>() {
      @Override
      public void onCompleted() {
        Log.i(TAG, "Complete");
      }
