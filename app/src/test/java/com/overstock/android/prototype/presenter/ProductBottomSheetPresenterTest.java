...
public class ProductBottomSheetPresenterTest {
  ...
  private static final String PARSE_USER_CART_ID = "11111";
  ...
  public void setUp() {
    ...
    productBottomSheetPresenter = new ProductBottomSheetPresenterImpl(checkOutCoordinator);
  ...
  public void testInitiateCheckout(){
    when(checkOutCoordinator.getCartIdForParseUser()).thenReturn(PARSE_USER_CART_ID);
    productBottomSheetPresenter.initiateCheckout();
  }
